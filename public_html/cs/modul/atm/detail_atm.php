                       ...
                       <div class="col-md-9">
                           <div class="profile-desk">
                               ...
                               <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                 <tr>
                                   <td valign="top"><strong>ID ATM</strong></td>
                                   <td valign="top"><div align="center">:</div></td>
                                   <td valign="top"><span class="text-muted"><?php echo $spbu['id_atm']; ?></span></td>
                                 </tr>
								...
								<tr>
                                   ...
                                   <td width="2%" valign="top"><div align="center">:</div></td>
                                   <td width="78%" valign="top"><span class="text-muted"><?php echo $spbu['kategori']; ?></span></td>
                                 </tr>
